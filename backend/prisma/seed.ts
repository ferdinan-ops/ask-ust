...
async function questionSeed() {
  await prisma.question.create({
    data: {
      ...
      correct_answers: JSON.stringify([
        { value: 'Fakultas Ilmu Komputer', checked: true },
        { value: 'Fakultas Pertanian', checked: true },
        { value: 'Fakultas Kedokteran', checked: false },
        { value: 'Fakultas Ilmu Budaya', checked: true },
        { value: 'Fakultas Vokasi', checked: false },
        { value: 'Fakultas Keguruan dan Ilmu Pendidikan', checked: true }
      ])
    }
  })
  ...
  await prisma.question.create({
    data: {
      ...
      type: 'RADIO',
      options: JSON.stringify([
        { value: 'Disebelah fakultas ekonomi dan fakultas teknik' },
        { value: 'Disebelah kapel' },
        { value: 'Ditengah-tengah wilayah universitas' },
        { value: 'Disebelah fakultas ilmu komputer' },
        { value: 'Didekat jalan masuk utama' }
      ]),
  ...
  await prisma.question.create({
    data: {
      ...
      correct_answers: JSON.stringify([
        { value: 'Inkubator Sains', checked: false },
        { value: 'Pramuka', checked: false },
        { value: 'Paduan Suara', checked: true },
        { value: 'Startup', checked: false },
        { value: 'Taekwondo', checked: true }
      ])
    }
  })
  ...
  await prisma.question.create({
    data: {
      ...
      type: 'RADIO',
      options: JSON.stringify([
        { value: 'Waktu belajar mengajar dari jam 09.50 - 11.30' },
        { value: 'Waktu belajar mengajar dari jam 10.40 - 12.20' },
        { value: 'Waktu istirahat' },
        { value: 'Waktu doa bersama' }
      ]),
